...
ub_p = [1E-5 1E-2 1 1 5 1 5]; %upper bounds for the prior
...
UB=[1E-5 1E-2 1 1 5 1 5];  %upper allowed parameter bounds
%A and b are for linear constraints corresponding to alpha3 and
%beta3
A = [0 0 0 -1 0 1 0;0 0 0 0 -1 0 1];
b = [0;0];
[theta1,fval,exitflag,output,population,scores] = ga(@(p) ODECalc_hazard_SimpleBirth(p,T,data1,Cell_num_array(:,3),Age,N0,bm,Menarche_Age), 7, A,b,[],[],LB',UB',[],[],opts);
theta2 = [theta1 fval];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
